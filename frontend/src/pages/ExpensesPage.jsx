...
const ExpensesPage = () => {
  ...
  // Mock budget categories for deviation chart
  ...
  const budget = mockTrips[0]?.budget || 0;
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-8">
            <CurrencyConverter />
            <ExportReport tripName="European Adventure" onExport={(format) => console.log(`Exporting as ${format}`)} />
          </div>
...
const AddExpenseModal = ({ isOpen, onClose, onSubmit, trips }) => {
